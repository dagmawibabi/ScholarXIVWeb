			...
			<div class="grid gap-4">
				<div class="space-y-1">
					{#each aiConversationState.selectedPapersList as eachSelectedPaper}
						<div
							class="flex cursor-default overflow-clip rounded-sm border hover:border-black hover:bg-white"
						>
							...
							<div
								class="flex cursor-pointer items-center border-l px-3 text-zinc-500 hover:bg-zinc-100 hover:text-red-500"
